...
# 1915 "./vl53/core/vl53l0x_api.h"
 ...
 uint32_t *refSpadCount, uint8_t *isApertureSpads);
# 31 "vl53/core/vl53l0x_api_core.c" 2
  ...
  uint8_t *pPalRangeStatus)
{
 ...
 (void)0;
# 406 "vl53/core/vl53l0x_api_core.c"
...
# 639 "vl53/core/vl53l0x_api_core.c"
 ...
 if ((Status == ((VL53L0X_Error) 0)) && (ReadDataFromDeviceDone != 7)) {
  ...
  if (((option & 4) == 4) &&
   ...
   SignalRateMeasFixed400mmFix =(FixPoint1616_t)(SignalRateMeasFixed1104_400_mm<<9);
...
VL53L0X_Error VL53L0X_load_tuning_settings(VL53L0X_DEV Dev, uint8_t *pTuningSettingBuffer)
{
 ...
 while ((*(pTuningSettingBuffer + Index) != 0) && (Status == ((VL53L0X_Error) 0))) {
...
# 964 "vl53/core/vl53l0x_api_core.c"
  }
 }
 ...
 FixPoint1616_t *pSigmaEstimate)
{
  ...
  *pSigmaEstimate = cSigmaEstMax;
  ...
  deltaT_ps = pRangingMeasurementData->RangeMilliMeter *
     cTOF_per_mm_ps;
# 1147 "vl53/core/vl53l0x_api_core.c"
...
VL53L0X_Error VL53L0X_set_measurement_timing_budget_micro_seconds( VL53L0X_DEV Dev, uint32_t MeasurementTimingBudgetMicroSeconds)
{
 ...
 if (Status == ((VL53L0X_Error) 0) &&
  ...
  Status = get_sequence_step_timeout(Dev, ((VL53L0X_VcselPeriod) 2), &MsrcDccTccTimeoutMicroSeconds);
 ...
 if (SchedulerSequenceSteps.PreRangeOn) {
  ...
  Status = get_sequence_step_timeout(Dev, ((VL53L0X_VcselPeriod) 3), &PreRangeTimeoutMicroSeconds);
...
# 1650 "vl53/core/vl53l0x_api_core.c"
  Status = set_sequence_step_timeout(Dev, ((VL53L0X_VcselPeriod) 4), FinalRangeTimingBudgetMicroSeconds);
...
# 2042 "vl53/core/vl53l0x_api_core.c"
  switch (VcselPeriodType) {
  case ((VL53L0X_VcselPeriod) 0):
   Status = get_sequence_step_timeout(Dev,
    ((VL53L0X_VcselPeriod) 3),
