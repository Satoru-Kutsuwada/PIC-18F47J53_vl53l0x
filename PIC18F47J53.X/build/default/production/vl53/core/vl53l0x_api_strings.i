# 1 "vl53/core/vl53l0x_api_strings.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "vl53/core/vl53l0x_api_strings.c" 2
# 28 "vl53/core/vl53l0x_api_strings.c"
# 1 ".\\system.h" 1
# 23 ".\\system.h"
...
# 29 "vl53/core/vl53l0x_api_strings.c" 2
...
# 1915 "./vl53/core/vl53l0x_api.h"
 ...
 uint32_t *refSpadCount, uint8_t *isApertureSpads);
# 30 "vl53/core/vl53l0x_api_strings.c" 2
# 45 "vl53/core/vl53l0x_api_strings.c"
...
VL53L0X_Error VL53L0X_get_device_info(VL53L0X_DEV Dev, VL53L0X_DeviceInfo_t *pVL53L0X_DeviceInfo)
{
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  Status = VL53L0X_RdByte(Dev, 0x00c0, &pVL53L0X_DeviceInfo->ProductType);
 }

 if (Status == ((VL53L0X_Error) 0)) {
  Status = VL53L0X_RdByte(Dev, 0x00c2, &revision_id);
