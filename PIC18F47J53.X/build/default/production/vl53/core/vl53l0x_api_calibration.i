# 1 "vl53/core/vl53l0x_api_calibration.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "vl53/core/vl53l0x_api_calibration.c" 2
# 29 "vl53/core/vl53l0x_api_calibration.c"
# 1 ".\\system.h" 1
# 23 ".\\system.h"
...
# 30 "vl53/core/vl53l0x_api_calibration.c" 2
...
# 47 "./vl53/platform\\vl53l0x_types.h"
...
# 1915 "./vl53/core/vl53l0x_api.h"
 ...
 uint32_t *refSpadCount, uint8_t *isApertureSpads);
# 31 "vl53/core/vl53l0x_api_calibration.c" 2
 ...
 uint8_t *pVhvSettings, uint8_t *pPhaseCal, uint8_t get_data_enable)
{
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  ...
  Status = VL53L0X_WrByte(Dev, 0x0001, SequenceConfig);
  if (Status == ((VL53L0X_Error) 0))
...
# 301 "vl53/core/vl53l0x_api_calibration.c"
 ...
 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_WrByte(Dev, 0x4F, 0x00);
 ...
 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_WrByte(Dev, 0xB6, startSelect);


 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_WrByte(Dev, 0x80, 0);
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  ...
  if ((Status == ((VL53L0X_Error) 0)) && (peakSignalRateRef > targetRefRate)) {
...
# 391 "vl53/core/vl53l0x_api_calibration.c"
 ...
 if ((Status == ((VL53L0X_Error) 0)) && (peakSignalRateRef < targetRefRate)) {
# 411 "vl53/core/vl53l0x_api_calibration.c"
...
# 482 "vl53/core/vl53l0x_api_calibration.c"
   ...
   uint32_t curr, int32_t *next)
{
 ...
 uint8_t dataByte;
 uint8_t success = 0;
# 665 "vl53/core/vl53l0x_api_calibration.c"
 *next = -1;
...
# 723 "vl53/core/vl53l0x_api_calibration.c"
 currentSpad = offset;
