# 1 "vl53/platform/vl53l0x_platform.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "vl53/platform/vl53l0x_platform.c" 2
# 37 "vl53/platform/vl53l0x_platform.c"
# 1 ".\\system.h" 1
# 23 ".\\system.h"
...
# 37 "vl53/platform/vl53l0x_platform.c" 2

# 1 "./vl53/platform/vl53l0x_platform.h" 1
# 33 "./vl53/platform/vl53l0x_platform.h"
...
# 33 "./vl53/platform/vl53l0x_platform.h" 2
...
# 1915 "./vl53/core\\vl53l0x_api.h"
 ...
 uint32_t *refSpadCount, uint8_t *isApertureSpads);
# 40 "vl53/platform/vl53l0x_platform.c" 2
...
# 97 "vl53/platform/vl53l0x_platform.c"
VL53L0X_Error VL53L0X_RdByte(VL53L0X_DEV Dev, uint8_t index, uint8_t *data){
...
VL53L0X_Error VL53L0X_PollingDelay(VL53L0X_DEV Dev)
{
    ...
    Wait(1);
# 245 "vl53/platform/vl53l0x_platform.c"
    return status;
}
